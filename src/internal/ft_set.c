...
/*   Updated: 2024/03/21 05:06:34 by dande-je         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_cmd(t_pipex *data, char **cmd);
void	set_pipex_environ(int argc, char **argv, t_pipex *data)
{
	...
	set_cmd(data, &data->left_cmd[CMD_ARG]);
	set_cmd(data, &data->right_cmd[CMD_ARG]);
	data->infile = *argv;
